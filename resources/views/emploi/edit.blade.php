            ...
            <div class="w-full md:w-3/4 lg:w-1/2">
                <div class="bg-white border border-gray-900 shadow-lg rounded-lg p-6">
                    <div class="flex justify-between items-center border-b border-gray-800 pb-3">
                        <h4 class="text-xl font-semibold">Modifier un Emploi</h4>
                    ...
                    <div class="p-4">
                        <form action="{{ route('emploi.update', $emploi->id) }}" method="POST">
                            ...
                            <div class="mb-3">
                                ...
                                <input type="text" name="nom" value="{{ $emploi->nom }}" class="mt-1 block w-full px-3 py-2 border border-gray-300 rounded-md shadow-sm focus:outline-none focus:ring-2 focus:ring-blue-500 focus:border-blue-500">
                            ...
                            <div class="mb-3">
                                ...
                                <select name="department_id" class="mt-1 block w-full px-3 py-2 border border-gray-300 rounded-md shadow-sm focus:outline-none focus:ring-2 focus:ring-blue-500 focus:border-blue-500">
                                    ...
                                    @foreach($departments as $department)
                                        <option value="{{ $department->id }}" {{ $emploi->department_id == $department->id ? 'selected' : '' }}>
                                            {{ $department->nom }}
                                        </option>
                                    @endforeach
                                </select>
